...
// ========== نظام إدارة المحتوى المتطور (Admin Panel) ==========
const AdminSystem = {
    adminUser: 'admin',
    adminPass: 'admin123',
    isLoggedIn: false,
    ...
    showLogin() {
        ...
        this.loginElement.innerHTML = `
            ...
            <button onclick="AdminSystem.closeLogin()" style="margin-top: 10px; width: 100%; padding: 10px; background: none; border: 1px solid var(--border-color); border-radius: 10px; cursor: pointer; color: var(--text-color);">
                إلغاء
            </button>
        `;
